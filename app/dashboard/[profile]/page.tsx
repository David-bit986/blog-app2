  ...
  return (
    <div>
      {session?.user.id === profileId ? (
         <h1 className="text-xl sm:text-2xl font-bold mb-4 text-black dark:text-white">Your Posts!</h1>
      ) : (
        <h1 className="text-xl sm:text-2xl font-bold mb-4 text-black dark:text-white">User Posts</h1>
      )}
      {posts.length === 0 ? (
